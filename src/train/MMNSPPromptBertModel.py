...
class MMNSPPromptBertModel(t.nn.Module):
    def __init__(self, pretrain_bert_path, prompt_labels_tids, vis_token, prefix=2):
        super(MMNSPPromptBertModel, self).__init__()
        ...
        self.nsp_linear_layer = t.nn.Linear(self.bert_config.hidden_size, 2)
        ...
        print(Announce.printMessage(), '--------Init MMNSPPromptBertModel--------')
    ...
    def get_nsp_output(self, tids, inputs_embeds, mask_prompt):
    ...
    def forward(self, tids, masks, vis1, vis2):
        ...
        nsp_logits = self.get_nsp_output(tids, input_embeds, mask0)
